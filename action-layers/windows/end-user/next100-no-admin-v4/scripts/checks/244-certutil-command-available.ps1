# ENDUSER_NOADMIN_CERTUTIL_COMMAND_AenterpriseILABLE_V1
# Certutil command availability
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_CERTUTIL_COMMAND_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CommandAvailable",
    "CommandName": "certutil.exe",
    "WarnIfMissing": false
}
'@ | ConvertFrom-Json

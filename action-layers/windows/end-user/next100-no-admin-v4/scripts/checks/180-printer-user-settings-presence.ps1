# ENDUSER_NOADMIN_PRINTER_USER_SETTINGS_PRESENCE_V1
# Printer user settings presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PRINTER_USER_SETTINGS_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "RegistryPresence",
    "RegistryPath": "HKCU:\\Software\\Microsoft\\Windows NT\\CurrentVersion\\Devices",

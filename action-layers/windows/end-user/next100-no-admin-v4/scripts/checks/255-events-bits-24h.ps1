# ENDUSER_NOADMIN_EVENTS_BITS_24H_V1
# BITS event count last 24h
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_EVENTS_BITS_24H_V1" -EvidenceRoot $EvidenceRoot

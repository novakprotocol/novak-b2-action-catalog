# ENDUSER_NOADMIN_PRINTER_PORT_CIM_COUNT_V1
# Printer port CIM count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PRINTER_PORT_CIM_COUNT_V1" -EvidenceRoot $EvidenceRoot

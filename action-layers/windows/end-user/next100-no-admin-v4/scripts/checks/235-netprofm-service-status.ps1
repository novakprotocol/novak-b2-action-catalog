# ENDUSER_NOADMIN_NETPROFM_SERVICE_STATUS_V1
# Network List service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_NETPROFM_SERVICE_STATUS_V1" -EvidenceRoot $EvidenceRoot

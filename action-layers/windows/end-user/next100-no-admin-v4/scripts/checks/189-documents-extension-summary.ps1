# ENDUSER_NOADMIN_DOCUMENTS_EXTENSION_SUMMARY_V1
# Documents file extension summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_DOCUMENTS_EXTENSION_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "FileExtensionSummary",

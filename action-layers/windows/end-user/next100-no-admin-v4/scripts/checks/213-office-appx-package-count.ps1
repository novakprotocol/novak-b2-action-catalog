# ENDUSER_NOADMIN_OFFICE_APPX_PACKAGE_COUNT_V1
# Current-user AppX package count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_OFFICE_APPX_PACKAGE_COUNT_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "AppxPackageCount"
}
'@ | ConvertFrom-Json

# ENDUSER_NOADMIN_NCA_SERVICE_STATUS_V1
# Network Connectivity Assistant service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_NCA_SERVICE_STATUS_V1" -EvidenceRoot $EvidenceRoot

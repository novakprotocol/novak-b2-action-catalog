# ENDUSER_NOADMIN_UDP_ENDPOINT_COUNT_V1
# UDP endpoint count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_UDP_ENDPOINT_COUNT_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "UdpEndpointCount"
}
'@ | ConvertFrom-Json

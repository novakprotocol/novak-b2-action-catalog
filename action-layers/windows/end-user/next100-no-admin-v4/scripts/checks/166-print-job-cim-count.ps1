# ENDUSER_NOADMIN_PRINT_JOB_CIM_COUNT_V1
# Print job CIM instance count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PRINT_JOB_CIM_COUNT_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CimCount",
    "ClassName": "Win32_PrintJob"
}
'@ | ConvertFrom-Json

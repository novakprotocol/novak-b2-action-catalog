# ENDUSER_NOADMIN_PNP_PRINTER_CLASS_SUMMARY_V1
# PnP printer class summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PNP_PRINTER_CLASS_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

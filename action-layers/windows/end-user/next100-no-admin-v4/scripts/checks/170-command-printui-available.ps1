# ENDUSER_NOADMIN_COMMAND_PRINTUI_AenterpriseILABLE_V1
# printui.dll command availability
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_COMMAND_PRINTUI_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CommandAvailable",
    "CommandName": "printui.exe",
    "WarnIfMissing": false
}
'@ | ConvertFrom-Json

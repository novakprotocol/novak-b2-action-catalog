# ENDUSER_NOADMIN_EVENTS_SECURITY_24H_V2_V1
# Security log warning/error count last 24h
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_EVENTS_SECURITY_24H_V2_V1" -EvidenceRoot $EvidenceRoot

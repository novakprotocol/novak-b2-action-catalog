# ENDUSER_NOADMIN_CURRENTUSER_ROOT_CERT_COUNT_V1
# CurrentUser Root certificate count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_CURRENTUSER_ROOT_CERT_COUNT_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CurrentUserCertStoreCount",
    "Store": "Root"
}
'@ | ConvertFrom-Json

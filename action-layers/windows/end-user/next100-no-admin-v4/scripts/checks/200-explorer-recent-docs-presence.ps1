# ENDUSER_NOADMIN_EXPLORER_RECENT_DOCS_PRESENCE_V1
# Explorer RecentDocs registry presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_EXPLORER_RECENT_DOCS_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "RegistryPresence",
    "RegistryPath": "HKCU:\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\RecentDocs",

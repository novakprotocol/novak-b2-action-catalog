# ENDUSER_NOADMIN_TCP_CONNECTION_STATE_COUNTS_V1
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_TCP_CONNECTION_STATE_COUNTS_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "TcpConnectionStateCounts"
}
'@ | ConvertFrom-Json

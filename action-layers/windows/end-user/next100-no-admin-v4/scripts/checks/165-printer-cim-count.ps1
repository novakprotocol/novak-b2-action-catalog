# ENDUSER_NOADMIN_PRINTER_CIM_COUNT_V1
# Printer CIM instance count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PRINTER_CIM_COUNT_V1" -EvidenceRoot $EvidenceRoot

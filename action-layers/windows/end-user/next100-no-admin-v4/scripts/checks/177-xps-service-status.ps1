# ENDUSER_NOADMIN_XPS_SERVICE_STATUS_V1
# XPS service status check
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_XPS_SERVICE_STATUS_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "ServiceStatus",
    "ServiceName": "XpsPrint"
}
'@ | ConvertFrom-Json

# ENDUSER_NOADMIN_STARTUP_APPROVED_COUNT_V1
# Startup approved entry count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_STARTUP_APPROVED_COUNT_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "StartupApprovedCount"
}
'@ | ConvertFrom-Json

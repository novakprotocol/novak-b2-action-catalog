# ENDUSER_NOADMIN_WINDOWS_ERROR_REPORTING_SERVICE_STATUS_V1
# Windows Error Reporting service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_WINDOWS_ERROR_REPORTING_SERVICE_STATUS_V1" -EvidenceRoot $EvidenceRoot

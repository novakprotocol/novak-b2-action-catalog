# ENDUSER_NOADMIN_PNP_BLUETOOTH_CLASS_SUMMARY_V1
# PnP Bluetooth class summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PNP_BLUETOOTH_CLASS_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "PnpClassSummary",
    "PnpClass": "Bluetooth"
}
'@ | ConvertFrom-Json

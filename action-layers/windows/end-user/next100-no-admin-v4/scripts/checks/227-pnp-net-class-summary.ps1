# ENDUSER_NOADMIN_PNP_NET_CLASS_SUMMARY_V1
# PnP Net class summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PNP_NET_CLASS_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOADMIN_WLAN_AUTOCONFIG_STATUS_V1
# WLAN AutoConfig service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_WLAN_AUTOCONFIG_STATUS_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOADMIN_BLUETOOTH_SERVICE_STATUS_V1
# Bluetooth support service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_BLUETOOTH_SERVICE_STATUS_V1" -EvidenceRoot $EvidenceRoot

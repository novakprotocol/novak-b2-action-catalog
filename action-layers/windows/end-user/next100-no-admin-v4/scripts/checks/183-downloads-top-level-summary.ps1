# ENDUSER_NOADMIN_DOWNLOADS_TOP_LEVEL_SUMMARY_V1
# Downloads top-level summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_DOWNLOADS_TOP_LEVEL_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "KnownFolderTopLevelSummary",

# ENDUSER_NOADMIN_PRINTER_REGISTRY_CONNECTIONS_PRESENT_V1
# Printer connections registry presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PRINTER_REGISTRY_CONNECTIONS_PRESENT_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "RegistryPresence",
    "RegistryPath": "HKCU:\\Printers\\Connections",

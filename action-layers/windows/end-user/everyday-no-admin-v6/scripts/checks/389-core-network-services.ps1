# ENDUSER_EVERYDAY_CORE_NETWORK_SERVICES_V1
# Core network service group status
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_CORE_NETWORK_SERVICES_V1" -EvidenceRoot $EvidenceRoot

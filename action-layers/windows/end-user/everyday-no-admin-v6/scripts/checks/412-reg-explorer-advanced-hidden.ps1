# ENDUSER_EVERYDAY_REG_EXPLORER_ADVANCED_HIDDEN_V1
# Explorer hidden files setting presence
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_REG_EXPLORER_ADVANCED_HIDDEN_V1" -EvidenceRoot $EvidenceRoot

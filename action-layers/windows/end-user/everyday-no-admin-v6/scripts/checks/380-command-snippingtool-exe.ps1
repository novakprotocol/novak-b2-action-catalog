# ENDUSER_EVERYDAY_COMMAND_SNIPPINGTOOL_EXE_V1
# snippingtool.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_SNIPPINGTOOL_EXE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "snippingtool.exe",
    "WarnIfMissing":  false,

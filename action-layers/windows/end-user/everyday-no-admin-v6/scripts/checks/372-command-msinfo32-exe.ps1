# ENDUSER_EVERYDAY_COMMAND_MSINFO32_EXE_V1
# msinfo32.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_MSINFO32_EXE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "msinfo32.exe",
    "WarnIfMissing":  false,

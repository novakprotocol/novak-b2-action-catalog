# ENDUSER_EVERYDAY_COMMAND_NETSTAT_EXE_V1
# netstat.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_NETSTAT_EXE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "netstat.exe",
    "WarnIfMissing":  false,

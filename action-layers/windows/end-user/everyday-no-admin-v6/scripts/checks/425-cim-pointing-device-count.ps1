# ENDUSER_EVERYDAY_CIM_POINTING_DEVICE_COUNT_V1
# Pointing device count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_CIM_POINTING_DEVICE_COUNT_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_REMOTE_ACCESS_PROCESS_GROUP_V1
# Remote access process group count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_REMOTE_ACCESS_PROCESS_GROUP_V1" -EvidenceRoot $EvidenceRoot

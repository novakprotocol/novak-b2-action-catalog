# ENDUSER_EVERYDAY_EVENTS_APP_ERROR_7D_V1
# Application error event count last 7 days
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_APP_ERROR_7D_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_CERT_CA_COUNT_V2_V1
# Current user CA certificate count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_CERT_CA_COUNT_V2_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_COMMAND_ROUTE_EXE_V1
# route.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_ROUTE_EXE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "route.exe",
    "WarnIfMissing":  false,

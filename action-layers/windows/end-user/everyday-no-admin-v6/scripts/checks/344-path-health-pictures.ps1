# ENDUSER_EVERYDAY_PATH_HEALTH_PICTURES_V1
# Pictures path health
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_PATH_HEALTH_PICTURES_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_PRINTER_SERVICES_V1
# Printer related service group status
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_PRINTER_SERVICES_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_COLLABORATION_PROCESS_GROUP_V1
# Collaboration process group count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COLLABORATION_PROCESS_GROUP_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type":  "ProcessGroupCount",
    "ProcessNames":  [
                         "Teams",
                         "ms-teams",
                         "Zoom",

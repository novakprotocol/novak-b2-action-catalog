# ENDUSER_EVERYDAY_EVENTS_DEFENDER_7D_V1
# Defender event count last 7 days
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_DEFENDER_7D_V1" -EvidenceRoot $EvidenceRoot

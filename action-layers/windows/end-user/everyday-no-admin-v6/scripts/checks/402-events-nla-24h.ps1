# ENDUSER_EVERYDAY_EVENTS_NLA_24H_V1
# Network Location Awareness event count last 24h
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_NLA_24H_V1" -EvidenceRoot $EvidenceRoot

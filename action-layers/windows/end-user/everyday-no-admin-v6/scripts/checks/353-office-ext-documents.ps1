# ENDUSER_EVERYDAY_OFFICE_EXT_DOCUMENTS_V1
# Documents Office/PDF extension summary
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_OFFICE_EXT_DOCUMENTS_V1" -EvidenceRoot $EvidenceRoot

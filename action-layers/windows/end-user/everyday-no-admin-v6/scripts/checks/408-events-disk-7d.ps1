# ENDUSER_EVERYDAY_EVENTS_DISK_7D_V1
# Disk event count last 7 days
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_DISK_7D_V1" -EvidenceRoot $EvidenceRoot

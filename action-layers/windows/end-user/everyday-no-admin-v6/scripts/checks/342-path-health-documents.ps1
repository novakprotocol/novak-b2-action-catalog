# ENDUSER_EVERYDAY_PATH_HEALTH_DOCUMENTS_V1
# Documents path health
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_PATH_HEALTH_DOCUMENTS_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_PDF_PROCESS_GROUP_V1
# PDF process group count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_PDF_PROCESS_GROUP_V1" -EvidenceRoot $EvidenceRoot

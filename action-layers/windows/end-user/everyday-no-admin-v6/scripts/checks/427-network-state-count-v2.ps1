# ENDUSER_EVERYDAY_NETWORK_STATE_COUNT_V2_V1
# TCP network state count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_NETWORK_STATE_COUNT_V2_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type":  "NetworkStateCount"
}
'@ | ConvertFrom-Json

# ENDUSER_EVERYDAY_REG_EXPLORER_HIDE_FILE_EXT_V1
# Explorer hide file extensions setting presence
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_REG_EXPLORER_HIDE_FILE_EXT_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_COMMAND_NET_EXE_V1
# net.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_NET_EXE_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_REMOTE_ACCESS_SERVICES_V1
# Remote access service group status
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_REMOTE_ACCESS_SERVICES_V1" -EvidenceRoot $EvidenceRoot

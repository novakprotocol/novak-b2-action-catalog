# ENDUSER_EVERYDAY_EVENTS_USERPROFILE_7D_V1
# User Profile Service event count last 7 days
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_USERPROFILE_7D_V1" -EvidenceRoot $EvidenceRoot

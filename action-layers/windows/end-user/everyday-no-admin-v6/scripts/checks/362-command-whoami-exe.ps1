# ENDUSER_EVERYDAY_COMMAND_WHOAMI_EXE_V1
# whoami.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_WHOAMI_EXE_V1" -EvidenceRoot $EvidenceRoot

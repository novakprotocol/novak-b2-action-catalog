# ENDUSER_EVERYDAY_BROWSER_PROCESS_GROUP_V1
# Browser process group count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_BROWSER_PROCESS_GROUP_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_CIM_DESKTOP_MONITOR_COUNT_V1
# Desktop monitor count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_CIM_DESKTOP_MONITOR_COUNT_V1" -EvidenceRoot $EvidenceRoot

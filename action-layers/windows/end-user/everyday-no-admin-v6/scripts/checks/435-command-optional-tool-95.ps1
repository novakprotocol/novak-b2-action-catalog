# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_95_V1
# Optional Windows tool availability 95
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_95_V1" -EvidenceRoot $EvidenceRoot

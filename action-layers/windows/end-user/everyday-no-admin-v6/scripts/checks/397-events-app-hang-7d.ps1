# ENDUSER_EVERYDAY_EVENTS_APP_HANG_7D_V1
# Application hang event count last 7 days
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_APP_HANG_7D_V1" -EvidenceRoot $EvidenceRoot

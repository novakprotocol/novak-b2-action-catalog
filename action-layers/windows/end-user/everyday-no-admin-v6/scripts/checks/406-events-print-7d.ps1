# ENDUSER_EVERYDAY_EVENTS_PRINT_7D_V1
# Print event count last 7 days
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_PRINT_7D_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_94_V1
# Optional Windows tool availability 94
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_94_V1" -EvidenceRoot $EvidenceRoot

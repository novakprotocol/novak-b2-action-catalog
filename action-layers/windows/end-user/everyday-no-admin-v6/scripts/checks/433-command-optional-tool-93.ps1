# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_93_V1
# Optional Windows tool availability 93
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_93_V1" -EvidenceRoot $EvidenceRoot

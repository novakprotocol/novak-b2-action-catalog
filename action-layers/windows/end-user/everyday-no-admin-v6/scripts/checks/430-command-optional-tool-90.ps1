# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_90_V1
# Optional Windows tool availability 90
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_90_V1" -EvidenceRoot $EvidenceRoot

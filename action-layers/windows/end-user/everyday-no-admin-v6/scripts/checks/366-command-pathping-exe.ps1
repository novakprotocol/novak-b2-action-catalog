# ENDUSER_EVERYDAY_COMMAND_PATHPING_EXE_V1
# pathping.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_PATHPING_EXE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "pathping.exe",
    "WarnIfMissing":  false,

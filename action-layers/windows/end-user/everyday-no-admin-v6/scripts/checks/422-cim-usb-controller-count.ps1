# ENDUSER_EVERYDAY_CIM_USB_CONTROLLER_COUNT_V1
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_CIM_USB_CONTROLLER_COUNT_V1" -EvidenceRoot $EvidenceRoot

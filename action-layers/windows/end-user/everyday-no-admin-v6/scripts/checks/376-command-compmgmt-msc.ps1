# ENDUSER_EVERYDAY_COMMAND_COMPMGMT_MSC_V1
# compmgmt.msc command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_COMPMGMT_MSC_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "compmgmt.msc",
    "WarnIfMissing":  false,

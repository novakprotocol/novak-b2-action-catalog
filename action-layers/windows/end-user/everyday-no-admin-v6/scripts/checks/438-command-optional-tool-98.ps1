# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_98_V1
# Optional Windows tool availability 98
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_98_V1" -EvidenceRoot $EvidenceRoot

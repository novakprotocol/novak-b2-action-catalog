# ENDUSER_EVERYDAY_EVENTS_WINDOWS_ERROR_REPORTING_7D_V1
# Windows Error Reporting event count last 7 days
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_WINDOWS_ERROR_REPORTING_7D_V1" -EvidenceRoot $EvidenceRoot

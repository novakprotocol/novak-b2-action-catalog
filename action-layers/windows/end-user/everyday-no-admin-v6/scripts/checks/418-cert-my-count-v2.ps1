# ENDUSER_EVERYDAY_CERT_MY_COUNT_V2_V1
# Current user My certificate count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_CERT_MY_COUNT_V2_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_100_V1
# Optional Windows tool availability 100
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_100_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_COMMAND_PERFMON_EXE_V1
# perfmon.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_PERFMON_EXE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "perfmon.exe",
    "WarnIfMissing":  false,

# ENDUSER_EVERYDAY_COMMAND_EVENTVWR_MSC_V1
# eventvwr.msc command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_EVENTVWR_MSC_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "eventvwr.msc",
    "WarnIfMissing":  false,

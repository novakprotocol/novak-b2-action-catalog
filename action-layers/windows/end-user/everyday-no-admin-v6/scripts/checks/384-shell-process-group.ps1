# ENDUSER_EVERYDAY_SHELL_PROCESS_GROUP_V1
# Windows shell process group count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_SHELL_PROCESS_GROUP_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_COMMAND_ARP_EXE_V1
# arp.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_ARP_EXE_V1" -EvidenceRoot $EvidenceRoot

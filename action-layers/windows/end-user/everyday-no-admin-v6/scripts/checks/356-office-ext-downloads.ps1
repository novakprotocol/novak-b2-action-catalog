# ENDUSER_EVERYDAY_OFFICE_EXT_DOWNLOADS_V1
# Downloads Office/PDF extension summary
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_OFFICE_EXT_DOWNLOADS_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_COMMAND_DXDIAG_EXE_V1
# dxdiag.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_DXDIAG_EXE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "dxdiag.exe",
    "WarnIfMissing":  false,

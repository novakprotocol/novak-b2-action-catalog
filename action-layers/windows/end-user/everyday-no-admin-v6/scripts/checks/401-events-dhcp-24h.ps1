# ENDUSER_EVERYDAY_EVENTS_DHCP_24H_V1
# DHCP event count last 24h
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_DHCP_24H_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_91_V1
# Optional Windows tool availability 91
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_91_V1" -EvidenceRoot $EvidenceRoot

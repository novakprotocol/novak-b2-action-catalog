# ENDUSER_EVERYDAY_PATH_HEALTH_DOWNLOADS_V1
# Downloads path health
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_PATH_HEALTH_DOWNLOADS_V1" -EvidenceRoot $EvidenceRoot

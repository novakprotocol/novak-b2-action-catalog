# ENDUSER_EVERYDAY_COMMAND_MAGNIFY_EXE_V1
# magnify.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_MAGNIFY_EXE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "magnify.exe",
    "WarnIfMissing":  false,

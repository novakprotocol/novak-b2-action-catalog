# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_88_V1
# Optional Windows tool availability 88
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_88_V1" -EvidenceRoot $EvidenceRoot

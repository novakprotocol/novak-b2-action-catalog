# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_99_V1
# Optional Windows tool availability 99
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_99_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_ENV_PATH_PRESENCE_V1
# PATH environment variable presence
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_ENV_PATH_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

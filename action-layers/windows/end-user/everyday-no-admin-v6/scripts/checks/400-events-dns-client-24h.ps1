# ENDUSER_EVERYDAY_EVENTS_DNS_CLIENT_24H_V1
# DNS Client event count last 24h
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_DNS_CLIENT_24H_V1" -EvidenceRoot $EvidenceRoot

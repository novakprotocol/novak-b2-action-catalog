# ENDUSER_EVERYDAY_COMMAND_WHERE_EXE_V1
# where.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_WHERE_EXE_V1" -EvidenceRoot $EvidenceRoot

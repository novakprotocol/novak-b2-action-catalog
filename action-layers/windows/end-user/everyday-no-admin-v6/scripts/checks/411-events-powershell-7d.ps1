# ENDUSER_EVERYDAY_EVENTS_POWERSHELL_7D_V1
# PowerShell event count last 7 days
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_POWERSHELL_7D_V1" -EvidenceRoot $EvidenceRoot

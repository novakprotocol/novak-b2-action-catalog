# ENDUSER_EVERYDAY_COMMAND_CONTROL_EXE_V1
# control.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_CONTROL_EXE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "control.exe",
    "WarnIfMissing":  false,

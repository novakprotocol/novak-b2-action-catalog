# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_96_V1
# Optional Windows tool availability 96
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_96_V1" -EvidenceRoot $EvidenceRoot

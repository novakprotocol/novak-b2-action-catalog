# ENDUSER_EVERYDAY_CORE_WINDOWS_SERVICES_V1
# Core Windows service group status
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_CORE_WINDOWS_SERVICES_V1" -EvidenceRoot $EvidenceRoot

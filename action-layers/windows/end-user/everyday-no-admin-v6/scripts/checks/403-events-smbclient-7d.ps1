# ENDUSER_EVERYDAY_EVENTS_SMBCLIENT_7D_V1
# SMB client event count last 7 days
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_SMBCLIENT_7D_V1" -EvidenceRoot $EvidenceRoot

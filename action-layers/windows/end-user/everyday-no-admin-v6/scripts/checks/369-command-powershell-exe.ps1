# ENDUSER_EVERYDAY_COMMAND_POWERSHELL_EXE_V1
# powershell.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_POWERSHELL_EXE_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_COMMAND_HOSTNAME_EXE_V1
# hostname.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_HOSTNAME_EXE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "hostname.exe",
    "WarnIfMissing":  false,

# ENDUSER_EVERYDAY_COMMAND_CLEANMGR_EXE_V1
# cleanmgr.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_CLEANMGR_EXE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "CommandName":  "cleanmgr.exe",
    "WarnIfMissing":  false,

# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_89_V1
# Optional Windows tool availability 89
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_89_V1" -EvidenceRoot $EvidenceRoot

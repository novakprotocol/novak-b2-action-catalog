# ENDUSER_EVERYDAY_COMMAND_CMD_EXE_V1
# cmd.exe command availability
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_CMD_EXE_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_SYNC_PROCESS_GROUP_V1
# Sync process group count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_SYNC_PROCESS_GROUP_V1" -EvidenceRoot $EvidenceRoot

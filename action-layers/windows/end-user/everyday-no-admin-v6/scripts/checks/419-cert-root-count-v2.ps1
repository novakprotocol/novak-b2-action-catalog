# ENDUSER_EVERYDAY_CERT_ROOT_COUNT_V2_V1
# Current user Root certificate count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_CERT_ROOT_COUNT_V2_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type":  "CertificateStoreCount",
    "Store":  "Root"
}
'@ | ConvertFrom-Json

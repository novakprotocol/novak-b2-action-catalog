# ENDUSER_EVERYDAY_EVENTS_TASK_SCHEDULER_7D_V1
# Task Scheduler event count last 7 days
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_EVENTS_TASK_SCHEDULER_7D_V1" -EvidenceRoot $EvidenceRoot

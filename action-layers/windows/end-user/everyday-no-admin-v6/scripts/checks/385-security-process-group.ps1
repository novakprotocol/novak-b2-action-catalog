# ENDUSER_EVERYDAY_SECURITY_PROCESS_GROUP_V1
# Security/Defender process group count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_SECURITY_PROCESS_GROUP_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_97_V1
# Optional Windows tool availability 97
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_COMMAND_OPTIONAL_TOOL_97_V1" -EvidenceRoot $EvidenceRoot

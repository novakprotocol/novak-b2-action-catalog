# ENDUSER_EVERYDAY_REG_EXPLORER_SHOW_SUPER_HIDDEN_V1
# Explorer super hidden setting presence
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_REG_EXPLORER_SHOW_SUPER_HIDDEN_V1" -EvidenceRoot $EvidenceRoot

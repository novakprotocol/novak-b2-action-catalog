# ENDUSER_EVERYDAY_OFFICE_PROCESS_GROUP_V1
# Office process group count
...
$ctx = New-NovakEvidenceContext -ActionId "ENDUSER_EVERYDAY_OFFICE_PROCESS_GROUP_V1" -EvidenceRoot $EvidenceRoot

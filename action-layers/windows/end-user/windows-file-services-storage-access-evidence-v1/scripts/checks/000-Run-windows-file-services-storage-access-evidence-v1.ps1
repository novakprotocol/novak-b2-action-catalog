...
$Scripts = @(Get-ChildItem -LiteralPath $Here -Filter '*.ps1' | Where-Object { $_.Name -match '^\d+-' -and $_.Name -ne '000-Run-windows-file-services-storage-access-evidence-v1.ps1' } | Sort-Object Name)
$Pass = 0
$Fail = 0

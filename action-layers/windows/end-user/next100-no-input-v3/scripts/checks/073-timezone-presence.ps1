# ENDUSER_NOINPUT_TIMEZONE_PRESENCE_V1
# Timezone property presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_TIMEZONE_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_POWER_PLAN_PRESENCE_V1
# Active power plan presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_POWER_PLAN_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "PowerPlanSummary"
}
'@ | ConvertFrom-Json

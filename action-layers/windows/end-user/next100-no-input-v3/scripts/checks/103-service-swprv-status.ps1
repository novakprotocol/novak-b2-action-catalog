# ENDUSER_NOINPUT_SERVICE_SWPRV_STATUS_V1
# Software Protection Provider service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_SERVICE_SWPRV_STATUS_V1" -EvidenceRoot $EvidenceRoot

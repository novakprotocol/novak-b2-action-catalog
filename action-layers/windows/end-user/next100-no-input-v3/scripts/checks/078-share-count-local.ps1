# ENDUSER_NOINPUT_SHARE_COUNT_LOCAL_V1
# Local share instance count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_SHARE_COUNT_LOCAL_V1" -EvidenceRoot $EvidenceRoot

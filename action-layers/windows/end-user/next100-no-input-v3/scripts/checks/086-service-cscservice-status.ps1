# ENDUSER_NOINPUT_SERVICE_CSCSERVICE_STATUS_V1
# Offline Files service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_SERVICE_CSCSERVICE_STATUS_V1" -EvidenceRoot $EvidenceRoot

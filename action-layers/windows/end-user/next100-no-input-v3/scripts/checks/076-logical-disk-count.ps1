# ENDUSER_NOINPUT_LOGICAL_DISK_COUNT_V1
# Logical disk instance count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_LOGICAL_DISK_COUNT_V1" -EvidenceRoot $EvidenceRoot

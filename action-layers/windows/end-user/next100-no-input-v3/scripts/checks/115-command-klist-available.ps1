# ENDUSER_NOINPUT_COMMAND_KLIST_AenterpriseILABLE_V1
# Klist command availability
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_COMMAND_KLIST_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CommandAvailable",
    "CommandName": "klist.exe",
    "WarnIfMissing": false
}
'@ | ConvertFrom-Json

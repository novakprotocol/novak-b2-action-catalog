# ENDUSER_NOINPUT_DRIVE_FIXED_SUMMARY_V1
# Fixed disk drive summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_DRIVE_FIXED_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

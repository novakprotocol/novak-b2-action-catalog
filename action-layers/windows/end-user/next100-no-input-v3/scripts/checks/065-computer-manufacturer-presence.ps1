# ENDUSER_NOINPUT_COMPUTER_MANUFACTURER_PRESENCE_V1
# Computer manufacturer/model property presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_COMPUTER_MANUFACTURER_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_REGISTRY_OFFLINE_FILES_POLICY_PRESENT_V1
# Offline files policy presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_REGISTRY_OFFLINE_FILES_POLICY_PRESENT_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_EVENTS_TASK_SCHEDULER_24H_V1
# Recent Task Scheduler warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_TASK_SCHEDULER_24H_V1" -EvidenceRoot $EvidenceRoot

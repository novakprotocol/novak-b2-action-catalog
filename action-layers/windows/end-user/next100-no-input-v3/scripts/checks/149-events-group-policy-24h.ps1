# ENDUSER_NOINPUT_EVENTS_GROUP_POLICY_24H_V1
# Recent Group Policy warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_GROUP_POLICY_24H_V1" -EvidenceRoot $EvidenceRoot

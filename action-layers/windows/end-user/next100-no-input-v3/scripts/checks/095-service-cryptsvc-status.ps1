# ENDUSER_NOINPUT_SERVICE_CRYPTSVC_STATUS_V1
# Cryptographic Services status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_SERVICE_CRYPTSVC_STATUS_V1" -EvidenceRoot $EvidenceRoot

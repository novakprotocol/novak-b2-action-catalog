# ENDUSER_NOINPUT_EVENTS_DEFENDER_24H_V1
# Recent Defender warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_DEFENDER_24H_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_EVENTS_WINDOWS_UPDATE_24H_V1
# Recent Windows Update warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_WINDOWS_UPDATE_24H_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_EVENTS_WMI_24H_V1
# Recent WMI warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_WMI_24H_V1" -EvidenceRoot $EvidenceRoot

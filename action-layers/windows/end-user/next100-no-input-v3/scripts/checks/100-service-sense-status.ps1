# ENDUSER_NOINPUT_SERVICE_SENSE_STATUS_V1
# Defender for Endpoint/Sense service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_SERVICE_SENSE_STATUS_V1" -EvidenceRoot $EvidenceRoot

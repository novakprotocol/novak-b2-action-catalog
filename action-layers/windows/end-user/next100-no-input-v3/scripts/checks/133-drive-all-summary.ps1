# ENDUSER_NOINPUT_DRIVE_ALL_SUMMARY_V1
# All logical drive summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_DRIVE_ALL_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

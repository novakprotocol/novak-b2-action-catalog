# ENDUSER_NOINPUT_KNOWN_FOLDER_DOWNLOADS_V1
# Known folder Downloads summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_KNOWN_FOLDER_DOWNLOADS_V1" -EvidenceRoot $EvidenceRoot

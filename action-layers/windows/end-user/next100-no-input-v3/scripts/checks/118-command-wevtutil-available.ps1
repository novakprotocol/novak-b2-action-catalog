# ENDUSER_NOINPUT_COMMAND_WEVTUTIL_AenterpriseILABLE_V1
# Wevtutil command availability
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_COMMAND_WEVTUTIL_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CommandAvailable",
    "CommandName": "wevtutil.exe",
    "WarnIfMissing": false
}
'@ | ConvertFrom-Json

# ENDUSER_NOINPUT_CIM_PARTITION_COUNT_V1
# Disk partition instance count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_CIM_PARTITION_COUNT_V1" -EvidenceRoot $EvidenceRoot

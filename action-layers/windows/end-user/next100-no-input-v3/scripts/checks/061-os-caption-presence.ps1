# ENDUSER_NOINPUT_OS_CAPTION_PRESENCE_V1
# OS caption property presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_OS_CAPTION_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

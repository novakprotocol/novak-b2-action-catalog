# ENDUSER_NOINPUT_FIREWALL_PROFILE_COUNTS_V1
# Firewall profile enabled counts
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_FIREWALL_PROFILE_COUNTS_V1" -EvidenceRoot $EvidenceRoot

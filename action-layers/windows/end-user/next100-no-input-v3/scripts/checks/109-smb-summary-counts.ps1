# ENDUSER_NOINPUT_SMB_SUMMARY_COUNTS_V1
# SMB mapping and connection counts with names redacted
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_SMB_SUMMARY_COUNTS_V1" -EvidenceRoot $EvidenceRoot

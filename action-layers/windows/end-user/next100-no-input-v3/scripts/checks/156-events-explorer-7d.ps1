# ENDUSER_NOINPUT_EVENTS_EXPLORER_7D_V1
# Recent Explorer-related warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_EXPLORER_7D_V1" -EvidenceRoot $EvidenceRoot

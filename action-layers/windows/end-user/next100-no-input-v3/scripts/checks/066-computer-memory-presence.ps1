# ENDUSER_NOINPUT_COMPUTER_MEMORY_PRESENCE_V1
# Computer memory property presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_COMPUTER_MEMORY_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

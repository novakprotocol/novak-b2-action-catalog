# ENDUSER_NOINPUT_EVENTS_POWERSHELL_24H_V1
# Recent PowerShell warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_POWERSHELL_24H_V1" -EvidenceRoot $EvidenceRoot

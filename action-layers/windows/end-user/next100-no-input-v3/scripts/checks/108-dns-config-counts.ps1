# ENDUSER_NOINPUT_DNS_CONFIG_COUNTS_V1
# DNS config counts with values redacted
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_DNS_CONFIG_COUNTS_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "DnsConfigSummary"
}
'@ | ConvertFrom-Json

# ENDUSER_NOINPUT_CIM_SHADOWCOPY_COUNT_V1
# Shadow copy instance count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_CIM_SHADOWCOPY_COUNT_V1" -EvidenceRoot $EvidenceRoot

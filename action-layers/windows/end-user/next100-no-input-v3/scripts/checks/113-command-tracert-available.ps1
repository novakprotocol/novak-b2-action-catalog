# ENDUSER_NOINPUT_COMMAND_TRACERT_AenterpriseILABLE_V1
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_COMMAND_TRACERT_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CommandAvailable",
    "CommandName": "tracert.exe",
    "WarnIfMissing": false
}
'@ | ConvertFrom-Json

...
This action layer covers basic Windows areas an end user may be able to correct in their own user context.

It is intentionally different from the earlier diagnostic action layers:

- The previous action layers mostly observed.
- This action layer contains self-fix candidates.

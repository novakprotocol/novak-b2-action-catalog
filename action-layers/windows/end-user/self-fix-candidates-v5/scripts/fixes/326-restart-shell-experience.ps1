# ENDUSER_SELF_FIX_RESTART_SHELL_EXPERIENCE_V1
# Restart Shell Experience Host
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_SHELL_EXPERIENCE_V1" -EvidenceRoot $EvidenceRoot

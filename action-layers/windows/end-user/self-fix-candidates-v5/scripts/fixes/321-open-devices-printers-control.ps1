# ENDUSER_SELF_FIX_OPEN_DEVICES_PRINTERS_CONTROL_V1
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_DEVICES_PRINTERS_CONTROL_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_SELF_FIX_RESTART_EXCEL_V1
# Restart Excel
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_EXCEL_V1" -EvidenceRoot $EvidenceRoot

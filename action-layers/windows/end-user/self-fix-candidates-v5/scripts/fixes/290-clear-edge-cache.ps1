# ENDUSER_SELF_FIX_CLEAR_EDGE_CACHE_V1
# Clear Edge user cache
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_CLEAR_EDGE_CACHE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "ClearKnownFolder",
    "FolderKind": "EdgeCache",
    "OlderThanDays": 0
}
'@ | ConvertFrom-Json

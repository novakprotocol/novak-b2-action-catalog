# ENDUSER_SELF_FIX_CREATE_SUPPORT_BUNDLE_AGAIN_V1
# Create support evidence bundle
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_CREATE_SUPPORT_BUNDLE_AGAIN_V1" -EvidenceRoot $EvidenceRoot

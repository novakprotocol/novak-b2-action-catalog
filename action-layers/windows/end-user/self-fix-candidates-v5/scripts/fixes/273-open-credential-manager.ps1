# ENDUSER_SELF_FIX_OPEN_CREDENTIAL_MANAGER_V1
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_CREDENTIAL_MANAGER_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "OpenControlPanelApplet",
    "Command": "/name Microsoft.CredentialManager"
}
'@ | ConvertFrom-Json

# ENDUSER_SELF_FIX_CLEAR_USER_TEMP_OLDER_7_DAYS_V1
# Clear user temp files older than 7 days
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_CLEAR_USER_TEMP_OLDER_7_DAYS_V1" -EvidenceRoot $EvidenceRoot

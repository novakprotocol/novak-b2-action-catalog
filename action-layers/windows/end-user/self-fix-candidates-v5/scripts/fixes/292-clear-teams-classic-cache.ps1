# ENDUSER_SELF_FIX_CLEAR_TEAMS_CLASSIC_CACHE_V1
# Clear Teams classic user cache
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_CLEAR_TEAMS_CLASSIC_CACHE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "ClearKnownFolder",
    "FolderKind": "TeamsClassicCache",
    "OlderThanDays": 0
}
'@ | ConvertFrom-Json

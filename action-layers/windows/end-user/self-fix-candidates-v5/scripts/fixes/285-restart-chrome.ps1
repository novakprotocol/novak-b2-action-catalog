# ENDUSER_SELF_FIX_RESTART_CHROME_V1
# Restart Chrome
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_CHROME_V1" -EvidenceRoot $EvidenceRoot

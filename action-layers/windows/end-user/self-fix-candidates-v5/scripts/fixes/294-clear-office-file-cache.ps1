# ENDUSER_SELF_FIX_CLEAR_OFFICE_FILE_CACHE_V1
# Clear Office file cache
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_CLEAR_OFFICE_FILE_CACHE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "ClearKnownFolder",
    "FolderKind": "OfficeFileCache",
    "OlderThanDays": 0
}
'@ | ConvertFrom-Json

# ENDUSER_SELF_FIX_RESTART_WIDGETS_V1
# Restart Widgets processes
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_WIDGETS_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_SELF_FIX_CLEAR_INTERNET_CACHE_V1
# Clear user internet cache files
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_CLEAR_INTERNET_CACHE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "ClearKnownFolder",
    "FolderKind": "InternetCache",
    "OlderThanDays": 0
}
'@ | ConvertFrom-Json

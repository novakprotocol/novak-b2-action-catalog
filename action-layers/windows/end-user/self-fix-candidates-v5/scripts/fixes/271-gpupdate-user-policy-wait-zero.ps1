# ENDUSER_SELF_FIX_GPUPDATE_USER_POLICY_WAIT_ZERO_V1
# Refresh user Group Policy no wait
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_GPUPDATE_USER_POLICY_WAIT_ZERO_V1" -EvidenceRoot $EvidenceRoot

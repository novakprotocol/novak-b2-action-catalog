# ENDUSER_SELF_FIX_RESTART_EXPLORER_V1
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_EXPLORER_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "RestartExplorer"
}
'@ | ConvertFrom-Json

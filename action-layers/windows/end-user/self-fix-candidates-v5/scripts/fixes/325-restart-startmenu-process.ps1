# ENDUSER_SELF_FIX_RESTART_STARTMENU_PROCESS_V1
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_STARTMENU_PROCESS_V1" -EvidenceRoot $EvidenceRoot

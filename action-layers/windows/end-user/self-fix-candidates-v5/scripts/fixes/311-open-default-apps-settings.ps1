# ENDUSER_SELF_FIX_OPEN_DEFAULT_APPS_SETTINGS_V1
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_DEFAULT_APPS_SETTINGS_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_SELF_FIX_RESTART_SEARCH_PROCESSES_V1
# Restart Search UI processes
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_SEARCH_PROCESSES_V1" -EvidenceRoot $EvidenceRoot

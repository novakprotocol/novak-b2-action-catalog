# ENDUSER_SELF_FIX_OPEN_APPS_FEATURES_SETTINGS_V1
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_APPS_FEATURES_SETTINGS_V1" -EvidenceRoot $EvidenceRoot

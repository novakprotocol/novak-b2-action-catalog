# ENDUSER_SELF_FIX_RUN_WSRESET_V1
# Run Microsoft Store cache reset
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RUN_WSRESET_V1" -EvidenceRoot $EvidenceRoot

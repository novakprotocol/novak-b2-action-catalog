# ENDUSER_SELF_FIX_OPEN_PRINTUI_USER_V1
# Open printer UI helper
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_PRINTUI_USER_V1" -EvidenceRoot $EvidenceRoot

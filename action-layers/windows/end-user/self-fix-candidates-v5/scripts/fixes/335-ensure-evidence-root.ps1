# ENDUSER_SELF_FIX_ENSURE_EVIDENCE_ROOT_V1
# Ensure self-check evidence root exists
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_ENSURE_EVIDENCE_ROOT_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_SELF_FIX_CREATE_SUPPORT_EVIDENCE_ZIP_V1
# Create support evidence ZIP
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_CREATE_SUPPORT_EVIDENCE_ZIP_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_SELF_FIX_OPEN_INTERNET_OPTIONS_V1
# Open Internet Options UI
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_INTERNET_OPTIONS_V1" -EvidenceRoot $EvidenceRoot

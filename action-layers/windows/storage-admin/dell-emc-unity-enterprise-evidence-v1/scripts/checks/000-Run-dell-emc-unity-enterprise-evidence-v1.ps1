...
$Scripts = @(Get-ChildItem -LiteralPath $Here -Filter '*.ps1' | Where-Object { $_.Name -match '^\d+-' -and $_.Name -ne '000-Run-dell-emc-unity-enterprise-evidence-v1.ps1' } | Sort-Object Name)

# ENDUSER_NOINPUT_KNOWN_FOLDER_PICTURES_V1
# Known folder Pictures summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_KNOWN_FOLDER_PICTURES_V1" -EvidenceRoot $EvidenceRoot

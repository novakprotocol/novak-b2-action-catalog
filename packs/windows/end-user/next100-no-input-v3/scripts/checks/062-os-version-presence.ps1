# ENDUSER_NOINPUT_OS_VERSION_PRESENCE_V1
# OS version/build property presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_OS_VERSION_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

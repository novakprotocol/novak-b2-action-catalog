# ENDUSER_NOINPUT_USER_PROFILE_COUNT_V1
# User profile instance count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_USER_PROFILE_COUNT_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_STORAGE_ENV_PRESENCE_V1
# Storage-related environment variable presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_STORAGE_ENV_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

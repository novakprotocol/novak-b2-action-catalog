# ENDUSER_NOINPUT_EVIDENCE_ROOT_SUMMARY_V1
# Self-check evidence root summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVIDENCE_ROOT_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "EvidenceRootSummary"
}
'@ | ConvertFrom-Json

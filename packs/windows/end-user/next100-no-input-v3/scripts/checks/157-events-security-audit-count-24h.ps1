# ENDUSER_NOINPUT_EVENTS_SECURITY_AUDIT_COUNT_24H_V1
# Recent Security log warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_SECURITY_AUDIT_COUNT_24H_V1" -EvidenceRoot $EvidenceRoot

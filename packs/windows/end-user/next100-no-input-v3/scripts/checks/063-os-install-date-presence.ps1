# ENDUSER_NOINPUT_OS_INSTALL_DATE_PRESENCE_V1
# OS install date property presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_OS_INSTALL_DATE_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

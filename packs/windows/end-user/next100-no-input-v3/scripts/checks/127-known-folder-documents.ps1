# ENDUSER_NOINPUT_KNOWN_FOLDER_DOCUMENTS_V1
# Known folder Documents summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_KNOWN_FOLDER_DOCUMENTS_V1" -EvidenceRoot $EvidenceRoot

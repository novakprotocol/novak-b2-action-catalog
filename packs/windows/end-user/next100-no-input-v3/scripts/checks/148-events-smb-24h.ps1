# ENDUSER_NOINPUT_EVENTS_SMB_24H_V1
# Recent SMB/client warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_SMB_24H_V1" -EvidenceRoot $EvidenceRoot

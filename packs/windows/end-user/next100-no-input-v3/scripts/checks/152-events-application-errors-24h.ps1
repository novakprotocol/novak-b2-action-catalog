# ENDUSER_NOINPUT_EVENTS_APPLICATION_ERRORS_24H_V1
# Recent application warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_APPLICATION_ERRORS_24H_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_DRIVE_REMOenterpriseBLE_SUMMARY_V1
# Removable drive summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_DRIVE_REMOenterpriseBLE_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

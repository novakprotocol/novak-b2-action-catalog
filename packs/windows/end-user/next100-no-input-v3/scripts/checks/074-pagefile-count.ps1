# ENDUSER_NOINPUT_PAGEFILE_COUNT_V1
# Pagefile usage instance count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_PAGEFILE_COUNT_V1" -EvidenceRoot $EvidenceRoot

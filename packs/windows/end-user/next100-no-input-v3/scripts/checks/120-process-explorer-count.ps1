# ENDUSER_NOINPUT_PROCESS_EXPLORER_COUNT_V1
# Explorer process count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_PROCESS_EXPLORER_COUNT_V1" -EvidenceRoot $EvidenceRoot

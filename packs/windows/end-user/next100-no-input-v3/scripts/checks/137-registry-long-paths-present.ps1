# ENDUSER_NOINPUT_REGISTRY_LONG_PATHS_PRESENT_V1
# Long paths policy presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_REGISTRY_LONG_PATHS_PRESENT_V1" -EvidenceRoot $EvidenceRoot

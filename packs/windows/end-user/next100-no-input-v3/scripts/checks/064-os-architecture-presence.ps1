# ENDUSER_NOINPUT_OS_ARCHITECTURE_PRESENCE_V1
# OS architecture property presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_OS_ARCHITECTURE_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

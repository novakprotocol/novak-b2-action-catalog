# ENDUSER_NOINPUT_SERVICE_NLASVC_STATUS_V1
# Network Location Awareness service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_SERVICE_NLASVC_STATUS_V1" -EvidenceRoot $EvidenceRoot

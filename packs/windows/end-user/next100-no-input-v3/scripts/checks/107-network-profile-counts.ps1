# ENDUSER_NOINPUT_NETWORK_PROFILE_COUNTS_V1
# Network profile category counts
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_NETWORK_PROFILE_COUNTS_V1" -EvidenceRoot $EvidenceRoot

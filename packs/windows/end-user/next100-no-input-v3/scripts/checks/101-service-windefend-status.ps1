# ENDUSER_NOINPUT_SERVICE_WINDEFEND_STATUS_V1
# Microsoft Defender Antivirus service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_SERVICE_WINDEFEND_STATUS_V1" -EvidenceRoot $EvidenceRoot

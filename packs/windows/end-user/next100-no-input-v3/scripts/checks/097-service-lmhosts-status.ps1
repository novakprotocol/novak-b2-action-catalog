# ENDUSER_NOINPUT_SERVICE_LMHOSTS_STATUS_V1
# TCP/IP NetBIOS Helper service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_SERVICE_LMHOSTS_STATUS_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_KNOWN_FOLDER_FAVORITES_V1
# Known folder Favorites summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_KNOWN_FOLDER_FAVORITES_V1" -EvidenceRoot $EvidenceRoot

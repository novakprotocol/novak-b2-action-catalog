# ENDUSER_NOINPUT_CIM_DISKDRIVE_COUNT_V1
# Disk drive instance count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_CIM_DISKDRIVE_COUNT_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_COMMAND_NSLOOKUP_AenterpriseILABLE_V1
# Nslookup command availability
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_COMMAND_NSLOOKUP_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CommandAvailable",
    "CommandName": "nslookup.exe",
    "WarnIfMissing": false
}
'@ | ConvertFrom-Json

# ENDUSER_NOINPUT_EVENTS_TERMINAL_SERVICES_24H_V1
# Recent Terminal Services warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_TERMINAL_SERVICES_24H_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_PORTABLE_CHASSIS_PRESENCE_V1
# System enclosure property presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_PORTABLE_CHASSIS_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

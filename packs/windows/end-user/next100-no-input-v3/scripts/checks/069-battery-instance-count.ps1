# ENDUSER_NOINPUT_BATTERY_INSTANCE_COUNT_V1
# Battery instance count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_BATTERY_INSTANCE_COUNT_V1" -EvidenceRoot $EvidenceRoot

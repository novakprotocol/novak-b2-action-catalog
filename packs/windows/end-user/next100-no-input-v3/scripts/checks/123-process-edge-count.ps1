# ENDUSER_NOINPUT_PROCESS_EDGE_COUNT_V1
# Microsoft Edge process count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_PROCESS_EDGE_COUNT_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_BIOS_PROPERTY_PRESENCE_V1
# BIOS property presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_BIOS_PROPERTY_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOINPUT_EVENTS_SERVICE_CONTROL_24H_V1
# Recent Service Control Manager warning/error count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_EVENTS_SERVICE_CONTROL_24H_V1" -EvidenceRoot $EvidenceRoot

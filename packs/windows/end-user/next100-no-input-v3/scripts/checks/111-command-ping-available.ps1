# ENDUSER_NOINPUT_COMMAND_PING_AenterpriseILABLE_V1
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_COMMAND_PING_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CommandAvailable",
    "CommandName": "ping.exe",
    "WarnIfMissing": true
}
'@ | ConvertFrom-Json

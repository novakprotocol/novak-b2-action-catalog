# ENDUSER_NOINPUT_KNOWN_FOLDER_DESKTOP_V1
# Known folder Desktop summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOINPUT_KNOWN_FOLDER_DESKTOP_V1" -EvidenceRoot $EvidenceRoot

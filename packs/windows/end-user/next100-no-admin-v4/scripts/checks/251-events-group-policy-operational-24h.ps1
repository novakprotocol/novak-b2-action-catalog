# ENDUSER_NOADMIN_EVENTS_GROUP_POLICY_OPERATIONAL_24H_V1
# GroupPolicy Operational event count last 24h
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_EVENTS_GROUP_POLICY_OPERATIONAL_24H_V1" -EvidenceRoot $EvidenceRoot

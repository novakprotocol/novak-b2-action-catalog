# ENDUSER_NOADMIN_EVENTS_VPNISH_NETWORK_24H_V1
# VPN/network-ish event count last 24h
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_EVENTS_VPNISH_NETWORK_24H_V1" -EvidenceRoot $EvidenceRoot

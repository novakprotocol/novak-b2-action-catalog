# ENDUSER_NOADMIN_PRINTER_DRIVER_CIM_COUNT_V1
# Printer driver CIM count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PRINTER_DRIVER_CIM_COUNT_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOADMIN_REMOTE_DESKTOP_USER_SETTING_PRESENCE_V1
# Remote Desktop user setting presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_REMOTE_DESKTOP_USER_SETTING_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOADMIN_SHADOWCOPY_COUNT_USER_VISIBLE_V1
# Shadow copy count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_SHADOWCOPY_COUNT_USER_VISIBLE_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOADMIN_ROUTE_CIM_COUNT_V1
# Route table CIM count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_ROUTE_CIM_COUNT_V1" -EvidenceRoot $EvidenceRoot

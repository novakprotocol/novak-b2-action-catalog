# ENDUSER_NOADMIN_CURRENTUSER_CA_CERT_COUNT_V1
# CurrentUser CA certificate count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_CURRENTUSER_CA_CERT_COUNT_V1" -EvidenceRoot $EvidenceRoot

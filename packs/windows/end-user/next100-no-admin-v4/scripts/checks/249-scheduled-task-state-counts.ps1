# ENDUSER_NOADMIN_SCHEDULED_TASK_STATE_COUNTS_V1
# Scheduled task state counts
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_SCHEDULED_TASK_STATE_COUNTS_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "ScheduledTaskCount"
}
'@ | ConvertFrom-Json

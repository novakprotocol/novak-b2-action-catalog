# ENDUSER_NOADMIN_EVENTS_PRINT_SERVICE_OPERATIONAL_24H_V1
# PrintService Operational warning/error count last 24h
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_EVENTS_PRINT_SERVICE_OPERATIONAL_24H_V1" -EvidenceRoot $EvidenceRoot

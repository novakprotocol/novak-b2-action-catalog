# ENDUSER_NOADMIN_WHOAMI_COMMAND_AenterpriseILABLE_V1
# Whoami command availability
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_WHOAMI_COMMAND_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CommandAvailable",
    "CommandName": "whoami.exe",
    "WarnIfMissing": true
}
'@ | ConvertFrom-Json

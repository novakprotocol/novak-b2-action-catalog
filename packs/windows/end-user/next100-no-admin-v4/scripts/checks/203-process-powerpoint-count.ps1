# ENDUSER_NOADMIN_PROCESS_POWERPOINT_COUNT_V1
# PowerPoint process count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PROCESS_POWERPOINT_COUNT_V1" -EvidenceRoot $EvidenceRoot

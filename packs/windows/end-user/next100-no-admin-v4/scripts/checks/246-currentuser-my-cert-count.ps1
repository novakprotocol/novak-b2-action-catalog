# ENDUSER_NOADMIN_CURRENTUSER_MY_CERT_COUNT_V1
# CurrentUser My certificate count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_CURRENTUSER_MY_CERT_COUNT_V1" -EvidenceRoot $EvidenceRoot

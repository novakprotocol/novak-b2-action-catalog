# ENDUSER_NOADMIN_COMMAND_IPCONFIG_AenterpriseILABLE_V1
# ipconfig command availability
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_COMMAND_IPCONFIG_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CommandAvailable",
    "CommandName": "ipconfig.exe",
    "WarnIfMissing": true
}
'@ | ConvertFrom-Json

# ENDUSER_NOADMIN_IPHLPSVC_SERVICE_STATUS_V1
# IP Helper service status
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_IPHLPSVC_SERVICE_STATUS_V1" -EvidenceRoot $EvidenceRoot

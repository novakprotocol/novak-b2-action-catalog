# ENDUSER_NOADMIN_CIPHER_COMMAND_AenterpriseILABLE_V1
# Cipher command availability
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_CIPHER_COMMAND_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CommandAvailable",
    "CommandName": "cipher.exe",
    "WarnIfMissing": false
}
'@ | ConvertFrom-Json

# ENDUSER_NOADMIN_USER_SHELL_FOLDERS_PERSONAL_PRESENCE_V1
# User Shell Folders Personal presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_USER_SHELL_FOLDERS_PERSONAL_PRESENCE_V1" -EvidenceRoot $EvidenceRoot

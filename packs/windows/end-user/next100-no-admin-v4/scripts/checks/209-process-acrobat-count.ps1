# ENDUSER_NOADMIN_PROCESS_ACROBAT_COUNT_V1
# Adobe Reader/Acrobat process count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PROCESS_ACROBAT_COUNT_V1" -EvidenceRoot $EvidenceRoot

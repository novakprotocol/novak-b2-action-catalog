# ENDUSER_NOADMIN_DISKDRIVE_COUNT_USER_VISIBLE_V1
# Disk drive count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_DISKDRIVE_COUNT_USER_VISIBLE_V1" -EvidenceRoot $EvidenceRoot

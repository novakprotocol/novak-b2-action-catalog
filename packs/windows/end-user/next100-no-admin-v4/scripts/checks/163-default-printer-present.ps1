# ENDUSER_NOADMIN_DEFAULT_PRINTER_PRESENT_V1
# Default printer present
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_DEFAULT_PRINTER_PRESENT_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "DefaultPrinterPresent"
}
'@ | ConvertFrom-Json

# ENDUSER_NOADMIN_ONEDRIVE_SETUP_COMMAND_AenterpriseILABLE_V1
# OneDrive setup command availability
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_ONEDRIVE_SETUP_COMMAND_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "CommandAvailable",
    "CommandName": "OneDriveSetup.exe",
    "WarnIfMissing": false
}
'@ | ConvertFrom-Json

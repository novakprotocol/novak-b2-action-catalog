# ENDUSER_NOADMIN_EVENTS_TEAMS_24H_V1
# Teams event count last 24h
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_EVENTS_TEAMS_24H_V1" -EvidenceRoot $EvidenceRoot

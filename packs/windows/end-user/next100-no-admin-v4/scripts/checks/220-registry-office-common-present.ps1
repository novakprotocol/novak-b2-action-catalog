# ENDUSER_NOADMIN_REGISTRY_OFFICE_COMMON_PRESENT_V1
# Office common registry presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_REGISTRY_OFFICE_COMMON_PRESENT_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "RegistryPresence",
    "RegistryPath": "HKCU:\\Software\\Microsoft\\Office\\Common",

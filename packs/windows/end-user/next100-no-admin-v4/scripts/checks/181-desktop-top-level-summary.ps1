# ENDUSER_NOADMIN_DESKTOP_TOP_LEVEL_SUMMARY_V1
# Desktop top-level summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_DESKTOP_TOP_LEVEL_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

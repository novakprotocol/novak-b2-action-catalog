# ENDUSER_NOADMIN_DOWNLOADS_EXTENSION_SUMMARY_V1
# Downloads file extension summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_DOWNLOADS_EXTENSION_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

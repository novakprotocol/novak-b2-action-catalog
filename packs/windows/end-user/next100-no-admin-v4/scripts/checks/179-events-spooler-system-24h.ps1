# ENDUSER_NOADMIN_EVENTS_SPOOLER_SYSTEM_24H_V1
# Spooler/System event count last 24h
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_EVENTS_SPOOLER_SYSTEM_24H_V1" -EvidenceRoot $EvidenceRoot

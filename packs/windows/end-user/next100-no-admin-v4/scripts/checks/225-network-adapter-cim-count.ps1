# ENDUSER_NOADMIN_NETWORK_ADAPTER_CIM_COUNT_V1
# Network adapter CIM count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_NETWORK_ADAPTER_CIM_COUNT_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_NOADMIN_EVENTS_EDGE_24H_V1
# Edge event count last 24h
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_EVENTS_EDGE_24H_V1" -EvidenceRoot $EvidenceRoot

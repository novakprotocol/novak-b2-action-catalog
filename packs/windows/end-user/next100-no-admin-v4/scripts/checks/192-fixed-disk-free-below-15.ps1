# ENDUSER_NOADMIN_FIXED_DISK_FREE_BELOW_15_V1
# Fixed disk below 15 percent free check
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_FIXED_DISK_FREE_BELOW_15_V1" -EvidenceRoot $EvidenceRoot

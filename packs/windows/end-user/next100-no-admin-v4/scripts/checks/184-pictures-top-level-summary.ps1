# ENDUSER_NOADMIN_PICTURES_TOP_LEVEL_SUMMARY_V1
# Pictures top-level summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_PICTURES_TOP_LEVEL_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

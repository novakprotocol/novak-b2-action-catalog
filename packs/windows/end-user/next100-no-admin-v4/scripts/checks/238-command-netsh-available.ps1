# ENDUSER_NOADMIN_COMMAND_NETSH_AenterpriseILABLE_V1
# netsh command availability
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_COMMAND_NETSH_AenterpriseILABLE_V1" -EvidenceRoot $EvidenceRoot

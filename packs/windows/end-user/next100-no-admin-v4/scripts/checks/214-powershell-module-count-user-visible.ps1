# ENDUSER_NOADMIN_POWERSHELL_MODULE_COUNT_USER_VISIBLE_V1
# PowerShell module count
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_POWERSHELL_MODULE_COUNT_USER_VISIBLE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "PowerShellModuleCount"
}
'@ | ConvertFrom-Json

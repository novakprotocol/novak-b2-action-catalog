# ENDUSER_NOADMIN_DESKTOP_EXTENSION_SUMMARY_V1
# Desktop file extension summary
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_DESKTOP_EXTENSION_SUMMARY_V1" -EvidenceRoot $EvidenceRoot

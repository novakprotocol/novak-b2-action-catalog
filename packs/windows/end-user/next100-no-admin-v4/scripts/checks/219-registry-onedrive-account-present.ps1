# ENDUSER_NOADMIN_REGISTRY_ONEDRIVE_ACCOUNT_PRESENT_V1
# OneDrive account registry presence
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_NOADMIN_REGISTRY_ONEDRIVE_ACCOUNT_PRESENT_V1" -EvidenceRoot $EvidenceRoot

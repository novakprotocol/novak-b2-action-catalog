# ENDUSER_SELF_FIX_RESTART_WORD_V1
# Restart Word
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_WORD_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_SELF_FIX_RESTART_TEAMS_V1
# Restart Teams processes
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_TEAMS_V1" -EvidenceRoot $EvidenceRoot

# ENDUSER_SELF_FIX_RESTART_TEXT_INPUT_HOST_V1
# Restart Text Input Host
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_TEXT_INPUT_HOST_V1" -EvidenceRoot $EvidenceRoot

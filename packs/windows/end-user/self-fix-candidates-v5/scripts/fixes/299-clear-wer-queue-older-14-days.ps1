# ENDUSER_SELF_FIX_CLEAR_WER_QUEUE_OLDER_14_DAYS_V1
# Clear WER queue older than 14 days
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_CLEAR_WER_QUEUE_OLDER_14_DAYS_V1" -EvidenceRoot $EvidenceRoot

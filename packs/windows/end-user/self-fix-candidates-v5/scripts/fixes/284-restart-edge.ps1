# ENDUSER_SELF_FIX_RESTART_EDGE_V1
# Restart Edge
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_EDGE_V1" -EvidenceRoot $EvidenceRoot

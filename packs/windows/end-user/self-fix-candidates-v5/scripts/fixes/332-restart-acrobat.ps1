# ENDUSER_SELF_FIX_RESTART_ACROBAT_V1
# Restart Adobe Reader/Acrobat
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_ACROBAT_V1" -EvidenceRoot $EvidenceRoot

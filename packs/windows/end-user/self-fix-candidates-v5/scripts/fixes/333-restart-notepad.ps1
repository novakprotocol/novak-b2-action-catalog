# ENDUSER_SELF_FIX_RESTART_NOTEPAD_V1
# Restart Notepad
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_NOTEPAD_V1" -EvidenceRoot $EvidenceRoot

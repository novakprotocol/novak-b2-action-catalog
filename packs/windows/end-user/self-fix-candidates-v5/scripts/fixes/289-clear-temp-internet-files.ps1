# ENDUSER_SELF_FIX_CLEAR_TEMP_INTERNET_FILES_V1
# Clear INetCache files
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_CLEAR_TEMP_INTERNET_FILES_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "ClearKnownFolder",
    "FolderKind": "TempInternetFiles",
    "OlderThanDays": 0
}
'@ | ConvertFrom-Json

# ENDUSER_SELF_FIX_RESTART_POWERPOINT_V1
# Restart PowerPoint
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_POWERPOINT_V1" -EvidenceRoot $EvidenceRoot

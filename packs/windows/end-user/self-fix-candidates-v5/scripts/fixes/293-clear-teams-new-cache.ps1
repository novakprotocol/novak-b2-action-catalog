# ENDUSER_SELF_FIX_CLEAR_TEAMS_NEW_CACHE_V1
# Clear new Teams user cache
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_CLEAR_TEAMS_NEW_CACHE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "ClearKnownFolder",
    "FolderKind": "TeamsNewCache",
    "OlderThanDays": 0
}
'@ | ConvertFrom-Json

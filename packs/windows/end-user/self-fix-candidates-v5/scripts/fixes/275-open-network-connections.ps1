# ENDUSER_SELF_FIX_OPEN_NETWORK_CONNECTIONS_V1
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_NETWORK_CONNECTIONS_V1" -EvidenceRoot $EvidenceRoot

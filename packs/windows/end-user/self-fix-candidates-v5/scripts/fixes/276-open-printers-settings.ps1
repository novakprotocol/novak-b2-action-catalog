# ENDUSER_SELF_FIX_OPEN_PRINTERS_SETTINGS_V1
# Open Printers settings UI
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_PRINTERS_SETTINGS_V1" -EvidenceRoot $EvidenceRoot

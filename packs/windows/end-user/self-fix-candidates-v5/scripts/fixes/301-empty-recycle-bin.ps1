# ENDUSER_SELF_FIX_EMPTY_RECYCLE_BIN_V1
# Empty Recycle Bin
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_EMPTY_RECYCLE_BIN_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "ClearRecycleBin"
}
'@ | ConvertFrom-Json

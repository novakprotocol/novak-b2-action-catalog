# ENDUSER_SELF_FIX_OPEN_ONEDRIVE_FOLDER_V1
# Open OneDrive folder if present
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_ONEDRIVE_FOLDER_V1" -EvidenceRoot $EvidenceRoot

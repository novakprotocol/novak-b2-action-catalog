# ENDUSER_SELF_FIX_RESTART_ONEDRIVE_V1
# Restart OneDrive
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_RESTART_ONEDRIVE_V1" -EvidenceRoot $EvidenceRoot
...
$Action = @'
{
    ...
    "StartCommand": "%LOCALAPPDATA%\\Microsoft\\OneDrive\\OneDrive.exe"
}
'@ | ConvertFrom-Json

# ENDUSER_SELF_FIX_OPEN_EVIDENCE_ROOT_V1
# Open self-check evidence root
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_EVIDENCE_ROOT_V1" -EvidenceRoot $EvidenceRoot

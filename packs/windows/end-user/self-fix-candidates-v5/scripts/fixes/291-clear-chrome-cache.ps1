# ENDUSER_SELF_FIX_CLEAR_CHROME_CACHE_V1
# Clear Chrome user cache
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_CLEAR_CHROME_CACHE_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "ClearKnownFolder",
    "FolderKind": "ChromeCache",
    "OlderThanDays": 0
}
'@ | ConvertFrom-Json

# ENDUSER_SELF_FIX_PURGE_KERBEROS_TICKETS_V1
# Purge current-user Kerberos tickets
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_PURGE_KERBEROS_TICKETS_V1" -EvidenceRoot $EvidenceRoot

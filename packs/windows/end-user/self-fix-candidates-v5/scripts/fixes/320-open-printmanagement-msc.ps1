# ENDUSER_SELF_FIX_OPEN_PRINTMANAGEMENT_MSC_V1
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_PRINTMANAGEMENT_MSC_V1" -EvidenceRoot $EvidenceRoot

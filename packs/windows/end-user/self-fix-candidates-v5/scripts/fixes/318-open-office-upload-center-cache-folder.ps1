# ENDUSER_SELF_FIX_OPEN_OFFICE_UPLOAD_CENTER_CACHE_FOLDER_V1
# Open Office file cache folder
...
$ctx = New-ItopsEvidenceContext -ActionId "ENDUSER_SELF_FIX_OPEN_OFFICE_UPLOAD_CENTER_CACHE_FOLDER_V1" -EvidenceRoot $EvidenceRoot

$Action = @'
{
    "Type": "OpenKnownFolder",
